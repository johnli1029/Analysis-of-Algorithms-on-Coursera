...
public class CopyStack<Item> implements Iterable<Item> {
    ...
    public CopyStack(CopyStack<Item> s)
    {
    	...
    	if(!s.isEmpty())
    	{
    		Node<Item> x = s.getfirst();
    		first = new Node<Item>(x);
    		for(Node<Item> probe = first; probe.next != null; probe = probe.next)
    		{
    			probe.next = new Node<Item>(probe.next);
    		}
    	}
    }
    /********************************************
     ...
     * private static class Node<Item> 
       {
        ...
        public CopyStack(CopyStack<Item> s)
        {
        	this.first = new Node(s.getfirst);
        }
    ...
    public static void main(String[] args) {
        CopyStack<String> stack = new CopyStack<String>();
        while (!StdIn.isEmpty()) {
        ...
        CopyStack<String> costack = new CopyStack<String>(stack);
        StdOut.println(stack);
        StdOut.println(costack);
    }
}
