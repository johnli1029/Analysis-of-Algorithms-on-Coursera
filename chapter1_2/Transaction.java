...
public class Transaction implements Comparable<Transaction> {
    ...
    private final static Comparator<Transaction> Who_Order= new WhoOrder();
    private final static Comparator<Transaction> When_Order= new WhenOrder();
    private final static Comparator<Transaction> HowMuch_Order= new HowMuchOrder();
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(a,Transaction.When_Order);
        for (int i = 0; i < a.length; i++)
            StdOut.println(a[i]);
        StdOut.println();

        StdOut.println("Sort by customer");
        Arrays.sort(a, Transaction.Who_Order);
        for (int i = 0; i < a.length; i++)
            StdOut.println(a[i]);
        StdOut.println();

        StdOut.println("Sort by amount");
        Arrays.sort(a, Transaction.HowMuch_Order);
        for (int i = 0; i < a.length; i++)
            StdOut.println(a[i]);
        StdOut.println();
    }
